...
>(({ className, children, ...props }, ref) => (
	<SelectPrimitive.Trigger
		ref={ref}
		className={cn(
			"flex h-[1rem] py-5 font-[400]  w-full items-center justify-between rounded-md border  px-4  text-sm   hover:bg-[#f7f7f7]  text-[#a0a0a0] placeholder:text-stone-500 focus:outline-none   bg-[#f9f9f9]   focus:bg-white  disabled:cursor-not-allowed disabled:opacity-50 dark:ring-offset-stone-950 dark:placeholder:text-stone-400 dark:focus:ring-stone-300     valid:border-[#292929] valid:bg-white valid:hover:bg-white focus:border-[#292929] dark:bg-[#292929]  dark:focus:bg-dark dark:border-[#292929] dark:focus:border-[#7a7a7a] dark:text-white transition-all duration-300  dark:shadow-none",
			className
		)}
		{...props}
	>
